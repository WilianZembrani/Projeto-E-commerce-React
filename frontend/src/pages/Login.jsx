  ...
  return (
    ...
    >
      ...
      {currentState === 'Login' ? (
        ...
        <input type="text" className="w-full px-3 py-2 border border-gray-800" placeholder="Nome" required />
      )}
      ...
      <div className="w-full flex justify-between text-sm mt-[-8px]">
        ...
        {currentState === 'Login' ? (
          ...
          <p>
            Tem uma conta?{' '}
            <b onClick={() => setCurrentState('Login')} className="cursor-pointer">
              Entre
            </b>
          </p>
        )}
      ...
      <button className="bg-black text-white font-light px-8 py-2 mt-4">
        {currentState === 'Login' ? 'Entrar' : 'Cadastre-se'}
      </button>
    </form>
  );
};
